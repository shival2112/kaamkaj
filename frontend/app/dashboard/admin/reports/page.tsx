    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        {loading ? (
          ...
          <>
            <section>
              <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">Users</h2>
            ...
            <section>
              <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">Jobs</h2>
              <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <section>
              <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">Applications</h2>
              <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            ...
            <section>
              <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">Summary</h2>
